function _mergeNamespaces(n, m) {
  ...
  const routes = {
    ...
    "routes/terms-and-conditions._index": {
      id: "routes/terms-and-conditions._index",
      parentId: "root",
    ...
    "routes/api.add-payment-to-order": {
      id: "routes/api.add-payment-to-order",
      parentId: "root",
      path: "api/add-payment-to-order",
      index: void 0,
      caseSensitive: void 0,
      hasLoader: true,
      hasAction: true,
    ...
    "routes/forgot-password.success": {
      id: "routes/forgot-password.success",
      parentId: "root",
    ...
    "routes/track-order._index": {
      id: "routes/track-order._index",
      parentId: "root",
      path: "track-order",
      index: true,
      caseSensitive: void 0,
    ...
    "routes/api.checkout-form": {
      id: "routes/api.checkout-form",
      parentId: "root",
      path: "api/checkout-form",
      index: void 0,
      caseSensitive: void 0,
      hasLoader: true,
      hasAction: true,
    ...
    "routes/shipping._index": {
      id: "routes/shipping._index",
      parentId: "root",
      path: "shipping",
      index: true,
      caseSensitive: void 0,
    ...
    "routes/sign-up._index": {
      id: "routes/sign-up._index",
      parentId: "root",
      path: "sign-up",
      index: true,
      caseSensitive: void 0,
    ...
    "routes/return._index": {
      id: "routes/return._index",
      parentId: "root",
      path: "return",
      index: true,
      caseSensitive: void 0,
  ...
  async function loadLazyRouteChildren(patchRoutesOnNavigationImpl, path, matches, routes2, manifest, mapRouteProperties, pendingRouteChildren, signal) {
