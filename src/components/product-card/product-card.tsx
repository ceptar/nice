...
export const ProductCard = ({
    ...
    return (
        <div className={styles.productCard} data-oid="ltru-u0">
        <div className="flex h-full w-full gap-0" data-oid="o-vh9p_">
            {/* Row 1: Image */}
            <div className="w-full h-full relative overflow-hidden" data-oid="i8glkvr">
                {imageUrl ? (
                    <img 
                        src={imageUrl} 
                        alt={name} 
            ...
            <div className="flex flex-col p-1 text-foreground   h-fit w-full bg-background ">
                <div className="flex flex-row px-1 placeholder:w-full h-full ">
                    <div className="overflow-hidden break-words text-sm font-medium uppercase leading-tight">
                        {name}
                    </div>
                </div>

                <div className="flex flex-row px-1 w-full h-full text-sm uppercase leading-tight font-regular">
                    <Price
                        priceWithTax={price}
