...
import { addPaymentToOrder } from '~/app/providers/checkout/checkout';
...
export function BraintreeDropIn(props: {
    ...
    return (
        <div
            ...
            data-oid="p914fwt"
        >
            <div id={'braintree-drop-in-div'} data-oid="2oxjj39" />

            <input type="hidden" name="paymentMethodCode" value="braintree" data-oid="r68hxya" />
            <button
