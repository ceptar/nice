...
export default function CookieConsent({ variant = "default", demo = false, onAcceptCallback = () => { }, onDeclineCallback = () => { } }) {
    ...
    return (
        variant == "default" ? (
            ...
            <div className={cn("fixed z-[200] bottom-8 invert sm:bottom-20 ml-8 right-8 sm:right-20 sm:max-w-sm duration-700", !isOpen ? "transition-[opacity,transform] translate-y-8 opacity-0" : "transition-[opacity,transform] translate-y-0 opacity-100", hide && "hidden")}>
                <div className="dark:bg-card bg-background border border-border rounded-lg">
                    ...
                    <div className="p-4 flex items-center gap-2 mt-2 border-t">
