...
export default function FacetFilterDrawer({
    ...
    return (
        <Sheet data-oid="im5ygot">
            ...
            <button className="top-[14px] z-[100] group fixed border-[#954eff3b] flex right-18 p-2 h-9 w-9 items-center justify-center overflow-hidden rounded-full  shadow-md shadow-gray-200 transition-all duration-500" >
            <Settings2
