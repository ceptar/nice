...
const CarouselItem = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
    ({ className, ...props }, ref) => {
        ...
        return (
            ...
            className={cn(
                'min-w-0 shrink-0 grow-0 basis-full border-r-[1px] border-black gap-0', // Added border
                orientation === 'horizontal' ? 'px-0' : 'pt-4', // Removed pl-4, added pr-4 for horizontal
                className,
            )}
            {...props}
            />
